...
void Mesh::Draw(
    ...
    for (unsigned int i = 0; i < textures.size(); i++) {
        ...
        textures[i].texUnit(shader, (type + num).c_str(), i); // NOLINT(cppcoreguidelines-narrowing-conversions)
        textures[i].Bind();
    }
    ...
    glDrawElements(GL_TRIANGLES, indices.size(), GL_UNSIGNED_INT, nullptr); // NOLINT(cppcoreguidelines-narrowing-conversions)
}
